...
public class MachineForm extends javax.swing.JInternalFrame {
    ...
    private void bnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnAddActionPerformed
        try {
            ...
            Machine machine=new Machine(ref, marque, prix,null);
    ...
    private void bnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnUpdateActionPerformed
        ...
        try {
            ...
            Salle salle=daoSalle.findById(machine.getSalle().getId());
    ...
    private void listMachinesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listMachinesMouseClicked
      ...
      String ref = listMachines.getModel().getValueAt(row, 1).toString();
      txtRef.setText(ref);
      String marque = listMachines.getModel().getValueAt(row, 2).toString();
      txtMarque.setText(marque);
      String prix = listMachines.getModel().getValueAt(row, 3).toString();
      txtPrix.setText(prix);
      String code = listMachines.getModel().getValueAt(row, 4).toString();
      txtCode.setText(code);
     this.id = Integer.parseInt(listMachines.getModel().getValueAt(row, 0).toString());        // TODO add your handling code here:
